          ...
          {["Jaga Anak", "Jaga Lansia", "Jaga Properti"].map((cat, i) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-bold shadow-sm transition
                ${
                  i === 0
                    ? "bg-accent text-white" // Aktif pakai primary
                    : "bg-background border border-slate-200 text-slate-500 hover:bg-gray-50"
                }
              `}
            >
              {cat}
        ...
        <form className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full border-2 border-slate-200 rounded-2xl py-3 px-4 text-center placeholder:text-orange-200 focus:outline-none focus:border-accent font-medium bg-background"
            />
          </div>
            ...
            <div className="flex gap-8">
              {["Laki-laki", "Perempuan"].map((gender) => (
                ...
                >
                  ...
                  <span className="text-slate-600 font-bold group-hover:text-primary transition">
                    {gender}
                  </span>
                </label>
              ))}
            ...
            <div className="border-2 border-slate-400 rounded-[2.5rem] p-6 space-y-4 bg-background">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  <input type="checkbox" className="w-6 h-6 accent-accent" />
                  <div className="flex-1 border-b border-dotted border-slate-300 text-slate-300">
                    ...
                  </div>
                </div>
              ))}
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="flex-1 border-2 border-slate-200 rounded-xl py-3 text-center focus:outline-none focus:border-accent bg-background"
                />
              </div>
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                type="text"
                placeholder="Pilih salah satu metode"
                className="w-full border-2 border-slate-200 rounded-2xl py-3 text-center focus:outline-none focus:border-accent bg-background"
              />
            </div>
            <div className="space-y-2">
              <label className="text-primary font-black text-lg">
              ...
              <input
                type="text"
                placeholder="Tulis nominal/barang/jasa"
                className="w-full border-2 border-slate-200 rounded-2xl py-3 text-center focus:outline-none focus:border-accent bg-background"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-10">
            ...
            <button className="bg-accent text-white px-12 py-4 rounded-[2rem] font-black text-lg shadow-xl shadow-orange-200 hover:bg-orange-500 active:scale-95 transition-all">
              Unggah
            </button>
          </div>
        </form>
